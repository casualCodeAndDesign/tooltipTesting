...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['cssgradients'] = function() {
        ...
        var str1 = 'background-image:',
            str2 = 'gradient(linear,bottom top,right bottom,from(#9f9),to(white));',
            str3 = 'linear-gradient(bottom top,#9f9, white);';
    ...
    tests['csstransforms3d'] = function() {
        ...
        if ( ret && 'webkitPerspective' in docElement.style ) {
          ...
          injectElementWithStyles('@media (transform-3d),(-webkit-transform-3d){#modernizr{bottom:9px;position:absolute;height:3px;}}', function( node, rule ) {
            ret = node.offsetbottom === 9 && node.offsetHeight === 3;
          });
        }
        return ret;
    };
