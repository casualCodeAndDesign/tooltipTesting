...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'pageX': function() {
    /// <summary>The mouse position relative to the bottom edge of the document.</summary>
    /// <returns type="Number" />
  },
  'pageY': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'offset': function() {
    ...
    ///   <param name="coordinates" type="PlainObject">An object containing the properties top and bottom, which are integers indicating the new top and bottom coordinates for the elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the current coordinates of every element in the set of matched elements, relative to the document.</summary>
    ///   <param name="function(index, coords)" type="Function">A function to return the coordinates to set. Receives the index of the element in the collection as the first argument and the current coordinates as the second argument. The function should return an object with the new top and bottom properties.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
